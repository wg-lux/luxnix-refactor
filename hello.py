...
# Define a function which creates a file (YYYY-MM-DD_HH-MM-SS.txt)
# in the directory "./data" and writes a message to it
...
#     if not message:
#         # print whether cuda is available, device name, total memory
#         # and multiprocessor count
#         message = "Hello from LuxNiX Administration Utils (with cuda support)!\n"
...
def main():
    print("Hello from Lx-Administration DevEnv!")
